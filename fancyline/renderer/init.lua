...
local component_providers = {
  ...
  branch_status = require("fancyline.components.branch_status"),
  bufnr = require("fancyline.components.bufnr"),
  checktime = require("fancyline.components.checktime"),
  commit_msg = require("fancyline.components.commit_msg"),
  cwd = require("fancyline.components.cwd"),
  dap = require("fancyline.components.dap"),
  fileformat = require("fancyline.components.fileformat"),
  filesize = require("fancyline.components.filesize"),
  git_signs = require("fancyline.components.git_signs"),
  lsp_clients = require("fancyline.components.lsp_clients"),
  macro_recording = require("fancyline.components.macro_recording"),
  project = require("fancyline.components.project"),
  quickfix = require("fancyline.components.quickfix"),
  reload = require("fancyline.components.reload"),
  search_stats = require("fancyline.components.search_stats"),
  spell = require("fancyline.components.spell"),
  tabnr = require("fancyline.components.tabnr"),
  treesitter = require("fancyline.components.treesitter"),
}
